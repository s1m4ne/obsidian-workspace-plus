...
var STRINGS = {
    ...
    ar: {
        ...
        deletedAllGroups: function (n) { return 'تم حذف ' + arPlural(n, 'مجموعة واحدة', 'مجموعتين', 'مجموعات', 'مجموعة'); },
        contextDeleteAllSessions: 'حذف جميع الجلسات',
        confirmDeleteAllSessions: function (n) { return 'حذف ' + arPlural(n, 'جلسة واحدة', 'جلستين', 'جلسات', 'جلسة') + '؟ سيتم الاحتفاظ بالجلسة النشطة.'; },
        deletedAllSessions: function (n) { return 'تم حذف ' + arPlural(n, 'جلسة واحدة', 'جلستين', 'جلسات', 'جلسة'); },
        ...
        historyRestored: function (name) { return 'تمت استعادة تخطيط "' + name + '"'; },
        historyQuickRestored: function (name) { return 'تمت استعادة التخطيط السابق لـ "' + name + '" بسرعة'; },
        historyNoEntries: 'لا توجد تخطيطات سابقة للاستعادة.',
        historyToday: 'اليوم',
        historyYesterday: 'أمس',
        historyThisWeek: 'هذا الأسبوع',
        historyFiles: function (n) { return arPlural(n, 'ملف واحد', 'ملفان', 'ملفات', 'ملف'); },
        historyPanes: function (n) { return arPlural(n, 'لوحة واحدة', 'لوحتان', 'لوحات', 'لوحة'); },
        ...
        rotationBackupRestoreConfirm: function (time, count) { return 'استعادة من النسخة الاحتياطية في ' + time + ' (' + arPlural(count, 'جلسة واحدة', 'جلستان', 'جلسات', 'جلسة') + ')؟ سيتم الكتابة فوق البيانات الحالية.'; },
        ...
        rotationBackupGeneration: function (count) { return arPlural(count, 'جلسة واحدة', 'جلستان', 'جلسات', 'جلسة'); },
    ...
    pt: {
        ...
        historyPanes: function (n) { return n + (n !== 1 ? ' painéis' : ' painel'); },
        ...
        rotationBackupRestore: 'Restaurar',
        rotationBackupRestoreConfirm: function (time, count) { return 'Restaurar do backup de ' + time + ' (' + count + (count !== 1 ? ' sessões' : ' sessão') + ')? Os dados atuais serão sobrescritos.'; },
        ...
        rotationBackupGeneration: function (count) { return count + (count !== 1 ? ' sessões' : ' sessão'); },
    ...
    ru: {
        ...
        rotationBackupRestoreConfirm: function (time, count) { return 'Восстановить из резервной копии от ' + time + ' (' + count + ' ' + ruPlural(count, 'сессия', 'сессии', 'сессий') + ')? Текущие данные будут перезаписаны.'; },
        ...
        rotationBackupGeneration: function (count) { return count + ' ' + ruPlural(count, 'сессия', 'сессии', 'сессий'); },
        frontmatterSessionNotFound: function (n) { return 'Сессия \u00ab' + n + '\u00bb не найдена (workspace-session)'; },
        frontmatterAlreadyActive: function (n) { return 'Сессия \u00ab' + n + '\u00bb уже активна'; },
    },
    de: {
    ...
    tr: {
        ...
        groupAddedSession: function (s, g) { return '"' + g + '" grubuna "' + s + '" eklendi'; },
        groupRemovedSession: function (s, g) { return '"' + g + '" grubundan "' + s + '" çıkarıldı'; },
        ...
        historyRestoreConfirm: function (name, time) { return '"' + name + '" düzeni ' + time + ' durumuna geri yüklensin mi?'; },
    ...
    th: {
        ...
        confirmReloadSession: function (n) { return 'โหลดเซสชัน "' + n + '" ซ้ำหรือไม่? การเปลี่ยนแปลงที่ยังไม่ได้บันทึกจะสูญหาย'; },
...
var EXTENDED_STRINGS = {
    ...
    ko: {
        ...
        exportSessionsDone: function (path) { return 'Workspace++: 세션을 ' + path + '(으)로 내보냈습니다.'; },
...
var SESSION_STORAGE_STRINGS = {
    ...
    ko: {
        ...
        sessionStorageMoved: function (path) { return 'Workspace++: 세션 저장 위치를 ' + path + '(으)로 옮겼습니다.'; },
    ...
    th: {
        ...
        sessionStorageMoved: function (path) { return 'Workspace++: ย้ายตำแหน่งจัดเก็บเซสชันไปยัง ' + path + ' แล้ว'; },
    ...
    hi: {
        ...
        sessionStorageMoved: function (path) { return 'Workspace++: सत्र संग्रहण ' + path + ' में स्थानांतरित किया गया।'; },
