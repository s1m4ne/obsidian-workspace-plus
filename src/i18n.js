...
var STRINGS = {
    ...
    id: {
        ...
        groupRemovedSession: function (s, g) { return '"' + s + '" dihapus dari "' + g + '"'; },
        groupRemoveFromGroup: 'Hapus dari grup',
        ...
        groupRemoveAllSessions: 'Hapus semua sesi dari grup ini',
        confirmRemoveAllFromGroup: function (g, n) { return 'Hapus semua ' + n + ' sesi dari "' + g + '"?'; },
        groupRemovedAllSessions: function (g) { return 'Semua sesi dihapus dari "' + g + '"'; },
